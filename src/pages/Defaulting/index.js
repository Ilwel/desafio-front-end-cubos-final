...
export default function Defaulting() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setOpen(true);
      const res = await fetch(makeUrl('report/clients') + `?query=inadimplentes`, {
        method: 'GET',
        headers: {
    ...
    <div className="l-clients">
      ...
      <div className="l-container">
        <div className="c-nav">
          ...
          <h1 onClick={() => setOpenModalTwo(!openModalTwo)} className="c-nav__second">Inadimplentes</h1>
        </div>
